...
// STL must use g++...
// g++ -g udpserver.c ../common/bmem.c ../common/server.c ../common/thread.cpp app.cpp room.cpp tcpcenter.cpp tcpclient.cpp tcpthread.cpp udpclient.cpp udpthread.cpp -o udpserver -lrt -lpthread -ljson
