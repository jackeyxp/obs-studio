...
define('kCmd_Camera_PullStart',       __LINE__ - CMD_LINE_START);
define('kCmd_Camera_PullStop',        __LINE__ - CMD_LINE_START);
define('kCmd_Camera_OnLineList',      __LINE__ - CMD_LINE_START);
define('kCmd_Camera_LiveStart',       __LINE__ - CMD_LINE_START);
define('kCmd_Camera_LiveStop',        __LINE__ - CMD_LINE_START);
